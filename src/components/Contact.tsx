                ...
                {contactInfo.map((item, index) => (
                  <div key={index} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6">
                    <div className="flex flex-col items-center text-center">
                      <div className="bg-gradient-to-br from-blue-500 to-emerald-500 p-3 rounded-lg text-white mb-4" aria-hidden="true">
                        {item.icon}
                      </div>
                      <h4 className="text-base font-semibold text-gray-900 mb-2">{item.title}</h4>
                      <p className="text-base text-blue-600 font-medium mb-2">{item.info}</p>
